...
#PBS -N PXD016469-LPS-phosphorylation-search
#PBS -o /scratch/st-ljfoster-1/logs/CFdb/PXD016469-LPS-phosphorylation-search.out
#PBS -e /scratch/st-ljfoster-1/logs/CFdb/PXD016469-LPS-phosphorylation-search.out
...
Rscript R/maxquant/run_maxquant.R \
    --mqpar_file ~/git/CFdb-searches/data/mqpar/PXD016469/mqpar-PXD016469-LPS.xml \
    ...
    --output_dir /scratch/st-ljfoster-1/CFdb/PXD016469/LPS-phosphorylation \
    --phosphorylation
