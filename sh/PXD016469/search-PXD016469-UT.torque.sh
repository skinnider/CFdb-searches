...
#PBS -N PXD016469-UT-search
#PBS -o /scratch/st-ljfoster-1/logs/CFdb/PXD016469-UT-search.out
#PBS -e /scratch/st-ljfoster-1/logs/CFdb/PXD016469-UT-search.out
...
Rscript R/maxquant/run_maxquant.R \
    ...
    --output_dir /scratch/st-ljfoster-1/CFdb/PXD016469/UT
