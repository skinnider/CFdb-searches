...
#PBS -N PXD016469-LPS-search
#PBS -o /scratch/st-ljfoster-1/logs/CFdb/PXD016469-LPS-search.out
#PBS -e /scratch/st-ljfoster-1/logs/CFdb/PXD016469-LPS-search.out
...
Rscript R/maxquant/run_maxquant.R \
    ...
    --output_dir /scratch/st-ljfoster-1/CFdb/PXD016469/LPS
