...
Rscript R/maxquant/PXD022309/write-mqpars.R \
  --raw_dir /scratch/st-ljfoster-1/CFdb/PXD022309 \
  --mqpar_file data/mqpar/PXD002322/mqpar-PXD002322-Hs_HCW_1-Bruker.xml \
  --output_dir data/mqpar/PXD022309
