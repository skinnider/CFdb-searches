# Write mqpar files for the PXD022340 (Stenton et al., JCI 2021) dataset.
...
# read summary files
summary = read.delim("data/mqpar/PXD022340/summary.txt.gz") %>% 
  drop_na(Experiment) %>% 
  filter(Raw.file != 'Total', Experiment != "") %>% 
  # drop one corrupted file
  filter(!grepl('P20_054_Revision_DNAJC30_HEK_KO_41', Raw.file))
